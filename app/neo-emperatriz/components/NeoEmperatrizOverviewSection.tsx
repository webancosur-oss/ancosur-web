...
const SUCCESS_TOAST: FeedbackToastData = {
  ...
  message:
    "Gracias por tu interés en Neo Emperatriz. Un asesor de Ancosur se comunicará contigo muy pronto para brindarte precios, disponibilidad, tipologías y formas de pago.",
};
