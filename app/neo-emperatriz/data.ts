export const whatsappNeoEmperatriz =
...
export const hero = {
  ...
  image: "/assets/projects/sliders/neoemperatriz.webp",
};
...
export const facts = [
  {
    label: "Dormitorios",
    value: "2 y 3 dormitorios",
  },
  {
    label: "Área",
    value: "Desde 67 m² hasta 109 m²",
  },
  {
    label: "Precio",
    value: "Desde S/ 274,700",
  },
];
...
export const details = [
  ...
  {
    label: "Ubicación",
    value: "Av. San Carlos 1481, Huancayo",
  },
  {
    label: "Referencia",
    value: "Cerca de la Universidad Continental",
  },
  {
    label: "Concepto",
    value: "Edificio ecológico y residencial",
  },
  {
    label: "Tipología",
    value: "Departamentos familiares de 2 y 3 dormitorios",
  },
  {
    label: "Amenidades",
    value:
      "Zona de fogata, bar privado, terraza BBQ, lobby y terraza social",
  },
  {
    label: "Ideal para",
    value:
      "Familias, parejas y personas que buscan un departamento listo para habitar",
  },
];
...
export const locationNeoEmperatriz = {
  projectAddress:
    "Av. San Carlos 1481, Huancayo",

  projectReference:
    "Cerca de la Universidad Continental.",
