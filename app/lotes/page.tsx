...
export default function ProyectosPage() {
  ...
  const [filter, setFilter] =
    useState<Filter>("entrega_inmediata");
        ...
        <div className={styles.catalogContainer}>
          <header className={styles.catalogHeader}>
            ...
            <p className={styles.catalogDescription}>
              Descubre lotes pensados para construir tu futuro y recibe asesoría personalizada para encontrar la mejor opción para ti.
            </p>
          </header>
            ...
            projects.length > 0 && (
              <div className={styles.filters}>
                <FilterTabs
                  ...
                  value={filter}
                  onChange={setFilter}
                  ariaLabel="Filtrar lotes por etapa"
                />
              </div>
            )}
