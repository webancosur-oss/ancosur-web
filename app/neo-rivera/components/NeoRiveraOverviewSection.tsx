...
const SUCCESS_TOAST: FeedbackToastData = {
  ...
  message:
    "Gracias por tu interés en Neo Rivera. Un asesor de Ancosur se comunicará contigo muy pronto para brindarte precios, disponibilidad, tipologías y formas de pago.",
};
      ...
      >
        <div className={styles.overviewInner}>
          <div className={styles.overviewContent}>
            ...
            <h2 id="neo-rivera-overview-title">
              El primer edificio wellness de
              Huancayo
            </h2>
            ...
            <p className={styles.overviewDescription}>
              ...
              y espacios creados para disfrutar
            ...
            <div className={styles.overviewActions}>
              <a
                ...
                download
                aria-label="Descargar brochure de Neo Rivera"
              >
                <DownloadSimpleIcon
                  size={18}
                  weight="bold"
