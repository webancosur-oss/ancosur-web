        ...
        <div className={styles.catalogContainer}>
          <header className={styles.catalogHeader}>
            ...
            <h1 className={styles.sectionTitle}>
              Elige tu próximo hogar
            </h1>

            <p className={styles.catalogDescription}>
              Descubre proyectos diseñados para elevar tu estilo de vida y recibe asesoría personalizada para elegir la mejor inversión.
            </p>
          </header>
            ...
            projects.length > 0 && (
              <div className={styles.filters}>
                <FilterTabs
                  ...
                  value={filter}
                  onChange={setFilter}
                  ariaLabel="Filtrar departamentos por etapa"
                />
              </div>
            )}
