...
const GOOGLE_MAPS_EMBED =
  `https://www.google.com/maps?q=${encodeURIComponent(
    locationNeoOrigen.googleMapsQuery
  )}&output=embed`;
...
export default function NeoOrigenLocation() {
 ...
 const handleSubmit = async (
  ...
  const formularioData = {
    codigo_formulario:
      "neo_origen_principal",

    nombre_formulario:
      "Formulario principal Neo Origen",
  ...
  try {
    ...
    if (
      ...
      console.error(
        "Error guardando lead Neo Origen:",
        {
          status:
            response.status,
  ...
  return (
    <>
      <section
        ...
        id="ubicacion-neo-origen"
        aria-labelledby="neo-origen-location-title"
      >
        {/* CABECERA */}
        ...
        >
          ...
          <h2 id="neo-origen-location-title">
            Tu próximo hogar te espera en
            Neo Origen
          </h2>

          <p>
            Vive en El Tambo, en una
            ubicación estratégica cerca de
            comercios, servicios, centros
            educativos y principales vías de
            acceso de Huancayo.
          </p>
        </div>
          ...
          >
            ...
            >
              <iframe
                ...
                title="Ubicación de Neo Origen en El Tambo, Huancayo"
                loading="lazy"
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <strong>
                    {
                      locationNeoOrigen.projectAddress
                    }
                  </strong>

                  <p>
                    {
                      locationNeoOrigen.projectReference
                    }
                  </p>
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <strong>
                  {
                    locationNeoOrigen.officeAddress
                  }
                </strong>

                <p>
                  {
                    locationNeoOrigen.schedule
                  }
                </p>
              </div>
            </div>
