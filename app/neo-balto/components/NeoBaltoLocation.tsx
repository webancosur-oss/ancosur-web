...
const SUCCESS_TOAST: FeedbackToastData = {
  ...
  message:
    "Gracias por tu interés en Neo Balto. Un asesor de ANCOSUR se comunicará contigo muy pronto para brindarte precios, tipologías, disponibilidad y formas de pago.",
};
...
export default function NeoBaltoLocation() {
  ...
  const handleSubmit = async (
     ...
     * - Tipo de lead.
     * - Mensaje, solo cuando el usuario escribe.
     *
    ...
    <>
      ...
      >
        <div className={styles.header}>
          ...
          <p>
            Vive junto a tu mascota en una
            zona residencial de Huancayo,
            cerca del parque Allqu Park y
            conectada con comercios, servicios
            y las principales vías de la
            ciudad.
          </p>
        </div>
