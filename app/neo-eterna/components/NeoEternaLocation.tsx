...
const CAMPAIGN_CODE = "Neo Eterna";
const AD_NAME = "Web";
const LEAD_TYPE = "WEB Ancosur";
const COMPONENT_NAME = "NeoEternaLocation";
...
const SUCCESS_TOAST: FeedbackToastData = {
  ...
  message:
    "Gracias por tu interés en Neo Eterna. Un asesor de Ancosur se comunicará contigo muy pronto para brindarte precios, tipologías, disponibilidad y formas de pago.",
};
...
export default function NeoEternaLocation() {
  ...
  const formularioData = {
    codigo_formulario:
      "neo_eterna_principal",

    nombre_formulario:
      "Formulario principal Neo Eterna",
  ...
  try {
    ...
    if (
      ...
      console.error(
        "Error guardando lead Neo Eterna:",
        {
          status:
            response.status,
